...
class PurchaseInvoiceController extends BaseController
{
    ...
    public function send_invoice_email(Request $request){
        $body = "You can download invoice from attachment.";
        $message = $request->invoice_message;
        $invoice_path = date('d_m_Y_His').".pdf";
        $pdf = App::make('dompdf.wrapper');
        $pdf->loadHTML($message)->save($invoice_path);
        ...
        $mail->addAddress("abdullaharif789@gmail.com");
